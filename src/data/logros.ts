...
export const logros: Logro[] = [
  ...
  },
  {
    ...
    before: { label: "Dólares escondidos — USD 250.000M", val: "$250B", desc: "Fuera del sistema. 2° stock mundial de dólares no bancarizados. Décadas de desconfianza. Dinero muerto." },
    after: { label: "Blanqueo récord", val: "$32B", desc: "Regularizados. 278K contribuyentes. Depósitos +160 %. USD 37.000 M en bancos — máximo desde la convertibilidad." },
    ...
    imgBefore: "/images/logros/17-antes.png",
    imgAfter: "/images/logros/17-despues.png",
  ...
  },
  {
    ...
    imgBefore: "/images/logros/18-antes.png",
    imgAfter: "/images/logros/18-despues.png",
  ...
  },
  {
    ...
    after: { label: "2025-2026 — transformación", val: "$55B+", desc: "Inversiones anunciadas. Bonos +20 % USD. Riesgo país <500. RIGI USD 25B aprobados. Argentina volvió al mapa." },
    ...
    imgBefore: "/images/logros/19-antes.png",
    imgAfter: "/images/logros/19-despues.png",
